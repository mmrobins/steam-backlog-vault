      ...
      gamesList = unplayed.map((game) => {
        ...
        if (prepopulated) {
          return {
            ...
            totalReviewsEnglish: prepopulated.totalReviewsEnglish ?? 0,
            metacritic: prepopulated.metacritic ?? null,
            metacriticUrl: prepopulated.metacriticUrl ?? (prepopulated.metacritic ? `https://www.metacritic.com/search/game/${encodeURIComponent(game.name)}/results` : null),
        ...
        return {
          ...
          totalReviewsEnglish: cachedReviews?.totalReviewsEnglish ?? 0,
    ...
    try {
      ...
      if (prepopulated) {
        return res.json({
          ...
          totalReviewsEnglish: prepopulated.totalReviewsEnglish,
          metacritic: prepopulated.metacritic,
          metacriticUrl: prepopulated.metacriticUrl,
